...
def _send_smtp(config: dict, to_address: str, cc_address: Optional[List[str]],
               subject: str, html_body: str, attachment_path: Optional[str],
               attachment_filename: Optional[str]) -> dict:
...
def send_email(config: dict, to_address: str, cc_address: Optional[List[str]],
               subject: str, html_body: str, attachment_path: Optional[str] = None,
    ...
    if provider == "smtp":
        return _send_smtp(config, to_address, cc_address, subject,
                          html_body, attachment_path, attachment_filename)
